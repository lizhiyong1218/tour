...
KindEditor.plugin('multiimage', function(K) {
	...
	console.log(myjsessionId);
	var self = this, name = 'multiimage',
		formatUploadUrl = K.undef(self.formatUploadUrl, true),
//		uploadJson = K.undef(self.uploadJson,  'http://localhost:8080/CMall/inside/goods/uploadImages;jsessionid="'+$.cookie("JSESSIONID")+'"'),
		uploadJson = K.undef(self.uploadJson,  'http://localhost:8080/CMall/inside/goods/uploadImages;jsessionid='+myjsessionId),
...
//			postParams :  K.undef(self.extraFileUploadParams, {}),
			postParams : $.extend(K.undef(self.extraFileUploadParams, {}), {"jsessionId": myjsessionId}),
